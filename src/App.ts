...
export class App {
  ...
  constructor(containerId: string) {
    ...
    const PANEL_SPANS_KEY = 'globalmonitor-panel-spans';
    ...
    const storedVariant = localStorage.getItem('globalmonitor-variant');
    ...
    if (storedVariant !== currentVariant) {
      ...
      const PANEL_ORDER_MIGRATION_KEY = 'globalmonitor-panel-order-v1.9';
      ...
      if (currentVariant === 'tech') {
        const TECH_INSIGHTS_MIGRATION_KEY = 'globalmonitor-tech-insights-top-v1';
    ...
    const LAYOUT_RESET_MIGRATION_KEY = 'globalmonitor-layout-reset-v2.5';
